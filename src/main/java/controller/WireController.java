    ...
    public void finishWireDrag(PortView target, double sceneX, double sceneY) {
        ...
        if (sourcePort != null && targetPort != null && sourcePort != targetPort) {
            ...
            if (isValidTarget(sourcePort, targetPort)) {
                ...
                System.out.println("🔍 DEBUG: Wire created - source: " + src.getPosition() + ", dest: " + dst.getPosition());
                System.out.println("🔍 DEBUG: Wire length: " + wire.getLength());
                System.out.println("🔍 DEBUG: connectionManager is null: " + (connectionManager == null));
                if (connectionManager != null && connectionManager.canAddWire(wire)) {
                    ...
                    if (connectionManager == null) {
                        System.out.println("❌ CONNECTION REJECTED: connectionManager is null");
                    } else {
