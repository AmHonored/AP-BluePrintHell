...
public abstract class Packet {
    ...
    // Constants
    protected static final double MAX_SPEED = 150.0, MIN_SPEED = 50.0, COMPATIBLE_SPEED_MULTIPLIER = 0.5;
    protected static final double INCOMPATIBLE_SPEED_MULTIPLIER = 1.0, DIVERSION_THRESHOLD = 20.0;
    ...
    public void setReachedEndSystem(boolean reached) {
        ...
        if (reached) System.out.println("Packet " + getId() + " marked as reached end system");
    }
